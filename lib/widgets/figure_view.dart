...
class _FigureViewState extends State<FigureView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animationSpin = Tween<double>(begin: 0, end: 1).animate(
      CurvedAnimation(
        parent: controllerSpin,
        curve: Curves.linear, // Aquí puedes especificar la curva que desees
      ),
    )..addListener(() {
        setState(() {});
      });
    ...
    if (widget.figureInfo.lvl == 1) {
      ...
      form = 'triskaidecagon';
      color = const Color.fromARGB(255, 163, 198, 168);
    } else if (widget.figureInfo.lvl == 12) {
      form = 'tetradecagon';
      color = const Color.fromARGB(255, 193, 151, 151);
    } else if (widget.figureInfo.lvl == 13) {
      form = 'pentadecagon';
      color = const Color.fromARGB(255, 116, 166, 109);
    } else {
      isCircule = true;
      color = Colors.white;
    }
          ...
          Center(
            child: ColorFiltered(
              ...
              child: SvgPicture.asset(
                'assets/figures/$form-border.svg',
                // colorFilter: const ColorFilter.mode(Color.fromARGB(91, 244, 67, 54), BlendMode.srcIn),
